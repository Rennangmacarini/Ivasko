...
export function CardsBook() {
  ...
  const revenues = [
    ...
    {
      id: 20,
      title: "BOLACHA DE FUBÁ",
      image: "./img/bolachafuba.jpeg",
  ...
  return (
    <>
      <div className={styles.content}>
        <div>
          <h1>Aperitivos</h1>
          <img src="./img/aperetivos.jpeg" alt="" />
        </div>

        <div>
          <h1>Pratos-Principais</h1>
          <img src="./img/pratos.jpeg" alt="" />
        </div>

        <div>
          <h1>Sobremesas</h1>
          <img src="./img/sobremesa.jpeg" alt="" />
        </div>

        <div>
          <h1>Pães e Bolos</h1>
          <img src="./img/bolo.jpeg" alt="" />
        </div>
      </div>
